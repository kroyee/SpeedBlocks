...
void PerformanceOutput::create(sf::Rect<int> _pos, UI* _ui) {
	createBase(_pos, _ui);
	pingIdCount=0;
	pingReturned=false;

	longest = ui->themeTG->load("Label");
	...
	longest->setFont(ui->resources.gfx.printFont);
	...
	longestHeader = ui->themeTG->load("Label");
	...
	longestHeader->setFont(ui->resources.gfx.printFont);
	...
	input->setFont(ui->resources.gfx.printFont);
	...
	inputHeader = ui->themeTG->load("Label");
	...
	inputHeader->setFont(ui->resources.gfx.printFont);
	...
	frame = ui->themeTG->load("Label");
	frame->setAutoSize(false);
	frame->setPosition(53,13);
	frame->setSize(28,15);
	frame->setText("");
	frame->setTextSize(12);
	frame->setFont(ui->resources.gfx.printFont);
	...
	frameHeader = ui->themeTG->load("Label");
	...
	frameHeader->setFont(ui->resources.gfx.printFont);
	...
	ping->setFont(ui->resources.gfx.printFont);
	...
	pingHeader = ui->themeTG->load("Label");
	...
	pingHeader->setFont(ui->resources.gfx.printFont);
