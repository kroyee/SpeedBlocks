...
void makeHorizontalLines(sf::Uint8 pixels[], sf::Color color, sf::Uint8 style) {
	sf::Uint8 a;
...
void makeVerticalLines(sf::Uint8 pixels[], sf::Color color, sf::Uint8 style) {
	sf::Uint8 a;
